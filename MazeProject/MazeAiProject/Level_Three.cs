...
namespace MazeAiProject
{
    public partial class Level_Three : Form
    {
        ...
        private void Level_Two_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Right:
        ...
        void restoreAll(Level_Three f)
        {
            this.picFrame.Location = new Point(385, 45);
        ...
        private void Level_Two_FormClosed(object sender, FormClosedEventArgs e)
        {
            simpleSound.Stop();
            Application.Exit();
        }
